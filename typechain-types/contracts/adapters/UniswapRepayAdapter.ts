...
export interface UniswapRepayAdapterInterface extends utils.Interface {
  functions: {
    ...
    "swapAndRepay(address,address,uint256,uint256,uint256,(uint256,uint256,uint8,bytes32,bytes32),bool)": FunctionFragment;
...
export interface UniswapRepayAdapter extends BaseContract {
  ...
  functions: {
    ...
    swapAndRepay(
      ...
      permitSignature: IBaseUniswapAdapter.PermitSignatureStruct,
      useEthPath: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
