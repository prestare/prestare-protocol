...
export interface UniswapLiquiditySwapAdapter extends BaseContract {
  ...
  functions: {
    ...
    swapAndDeposit(
      assetToSwapFromList: PromiseOrValue<string>[],
      assetToSwapToList: PromiseOrValue<string>[],
      amountToSwapList: PromiseOrValue<BigNumberish>[],
      minAmountsToReceive: PromiseOrValue<BigNumberish>[],
