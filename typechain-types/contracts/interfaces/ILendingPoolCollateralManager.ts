...
export interface ILendingPoolCollateralManagerInterface
...
export interface ILendingPoolCollateralManager extends BaseContract {
  ...
  filters: {
    "LiquidationCall(address,address,address,uint256,uint256,address,bool)"(
      ...
      principal?: PromiseOrValue<string> | null,
